...
Use this checklist to validate draw.io diagrams before exporting.
...
- [ ] Chinese text uses appropriate font (Noto Sans SC, etc.)
...
- [ ] Chinese text width: 20-30px per character minimum
...
<!-- After -->
<mxCell style="text;html=1;fontSize=18;fontFamily=Noto Sans SC;" />
```
...
### Issue: Chinese text wraps unexpectedly

**Cause**: Geometry width too narrow for text content

**Fix**: Increase width (20-30px per Chinese character)

```xml
<!-- 6 Chinese characters = 120-180px minimum -->
...
|----------|----------|---------|
| `fontFamily` | Yes (text) | `fontFamily=Noto Sans SC;` |
...
Before exporting a diagram, ask yourself:
