...
| `defaultFontFamily` | Default font | Noto Sans SC |
...
<mxCell id="box1"
  value="Label Text"
  style="rounded=1;whiteSpace=wrap;html=1;fontFamily=Noto Sans SC;fontSize=18;"
  vertex="1"
  parent="1">
...
<mxCell id="label1"
  ...
  style="text;html=1;align=center;verticalAlign=middle;fontFamily=Noto Sans SC;fontSize=18;"
  vertex="1"
  parent="1">
...
|-----------|-------------|
| `Noto Sans SC` | Google open source Chinese font (Recommended) |
